...
public class DbConnectivityClass {
    final static String DB_NAME="311semesterproject";
        MyLogger lg= new MyLogger();
        final static String SQL_SERVER_URL = "jdbc:mysql://311semesterproject.mysql.database.azure.com";//update this server name
        final static String DB_URL = "jdbc:mysql://311semesterproject.mysql.database.azure.com/"+DB_NAME;//update this database name
        final static String USERNAME = "slotk";// update this username
        final static String PASSWORD = "Perezoso123";// update this password
